...
#if USE_UWP
        const char* GADevice::_sdkWrapperVersion = "uwp_cpp 3.0.4";
#elif USE_TIZEN
        const char* GADevice::_sdkWrapperVersion = "tizen 3.0.4";
#else
        const char* GADevice::_sdkWrapperVersion = "cpp 3.0.4";
#endif
