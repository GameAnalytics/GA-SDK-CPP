...
#if USE_UWP
        const char* GADevice::_sdkWrapperVersion = "uwp_cpp 3.2.3";
#elif USE_TIZEN
        const char* GADevice::_sdkWrapperVersion = "tizen 3.2.3";
#else
        const char* GADevice::_sdkWrapperVersion = "cpp 3.2.3";
#endif
