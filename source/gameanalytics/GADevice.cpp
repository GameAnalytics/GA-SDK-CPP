...
#if USE_UWP
        const char* GADevice::_sdkWrapperVersion = "uwp_cpp 2.1.9";
#elif USE_TIZEN
        const char* GADevice::_sdkWrapperVersion = "tizen 2.1.9";
#else
        const char* GADevice::_sdkWrapperVersion = "cpp 2.1.9";
#endif
